...
void client_test_1(void) {
  CU_ASSERT_EQUAL( serverSearch("Connor"), 3);
  CU_ASSERT_EQUAL( serverSearch("Connor Bybee"), 3);
}

void client_test_2(void) {
  CU_ASSERT_EQUAL( serverSearch("123456789012345"), 0);
  CU_ASSERT_EQUAL( serverSearch("1234567890123456"), -1);
  CU_ASSERT_EQUAL( serverSearch("Fail test string"), -1);
}

void client_test_3(void) {
  CU_ASSERT_EQUAL( serverSearch("Fail test"), 0);
}
